...
public interface Mapper<Model, Entity, RequestCreation, RequestUpdate, Response> {
    Model toDomainFromRequestCreation(RequestCreation requestCreation) throws ClientHasNoLicenseException, ReservationForTooManyPeopleException, ClientDoesNotExistException, BoatDoesNotExistException;
